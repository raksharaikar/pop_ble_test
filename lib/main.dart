    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(
            seedColor: const Color.fromARGB(255, 84, 158, 243)),
        useMaterial3: true,
      ),
      home: const MyHomePage(title: 'POP LIGHTS TEST APP'),
    );
  }
}
...
class _FindDevicesScreenState extends State<FindDevicesScreen> {
  ...
  Widget build(BuildContext context) {
    return ScaffoldMessenger(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text('Find Poplights'),
        ),
...
//Write code start
                    ...
                    onWritePressed: () async {
                      try {
                        List<int> cmd_val = [0x2, 03, 01, 01];
                        await c.write(cmd_val,
